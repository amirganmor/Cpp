...
void detectDisplay(Mat frame, Mat& result, CascadeClassifier& face_cascade)
{
	...
	int minNeighbors = 3;
	createTrackbar("minNeighbors", "gray", &minNeighbors, 50);

	//Face detection
	vector<Rect> faces;
	face_cascade.detectMultiScale(frameGray, faces, 1.1, minNeighbors, 0 | CASCADE_SCALE_IMAGE, Size(30, 30));
...
int main()
{
	String face_cascade_name = "C:\\opencv\\sources\\data\\haarcascades_cuda\\haarcascade_frontalface_alt2.xml";
	String eyes_cascade_name = "C:\\opencv\\sources\\data\\haarcascades_cuda\\haarcascade_eye_tree_eyeglasses.xml";
