...
int main(int argc, char* argv[])
{
	...
	while (1) {
		...
		if (startNewRecording == true) {
			...
			oVideoWriter = VideoWriter("D:\\try\\MyVideo" + intToString(inc) + ".avi", VideoWriter::fourcc('M', 'J', 'P', 'G'), 20, frameSize, true); //initialize the VideoWriter object 
			...
			cout << "New video file created D:\\try\\MyVideo" + intToString(inc) + ".avi " << endl;
		...
		case 114:
			...
			if (firstRun == true) {
				...
				oVideoWriter = VideoWriter("D:\\try\\MyVideo0.avi", VideoWriter::fourcc('M', 'J', 'P', 'G'), 20, frameSize, true);
